...
return [
    ...
    */
    ...
    'confirmed'            => ':attribute と確認用は一致していなければいけません',
    ...
    */
    ...
    'values' => [
        'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'=>'Excel2007以降の新しい形式（拡張子が.xlsx）のファイルを選択してください。',
        'qtype' => [
            'radio' => '選択肢形式（単一回答）',
            'radio+t' => '選択肢形式（単一回答）（自由記載欄あり）',
            'checkbox' => '選択肢形式（複数回答）',
            'checkbox+t' => '選択肢形式（複数回答）（自由記載欄あり）',
        ],
    ],
